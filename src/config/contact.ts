...
export const contactFAQs: ContactFAQ[] = [
  ...
  },
  {
    ...
    answer:
      'MailLighter works with Microsoft 365 environments (Outlook desktop and Outlook on the web).',
  },
  {
    question: 'Is my data safe with MailLighter?',
    answer:
      'Yes. MailLighter processes emails locally and is fully GDPR compliant. No data leaves your environment.',
  },
];
