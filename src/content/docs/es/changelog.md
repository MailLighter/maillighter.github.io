---
title: "Versiones"
description: "Todas las versiones de MailLighter: nuevas funcionalidades, cambios y correcciones."
section: "Recursos"
order: 12
draft: false
---

Todos los cambios notables de MailLighter se documentan en esta página.

El formato sigue [Keep a Changelog](https://keepachangelog.com/).

## v1.0.0

Primera versión pública de MailLighter.

### Añadido

- **Eliminar imágenes** : elimina todas las imágenes integradas del cuerpo del correo, con notificación del espacio liberado
- **Eliminar archivos adjuntos** : elimina todos los archivos adjuntos (excluyendo imágenes integradas), con notificación del espacio liberado
