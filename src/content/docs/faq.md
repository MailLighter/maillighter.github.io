...
MailLighter is available on the Microsoft Marketplace. See the [Installation guide](/docs/installation) for step-by-step instructions.
...
Yes. MailLighter is fully GDPR compliant. It does not collect, store, or transmit any personal data or email content. See the [Privacy & Security](/docs/privacy-security) page for details.
...
Some email clients generate complex HTML that may not be fully parsed. If you encounter this, please report it using the [contact form](/contact).
